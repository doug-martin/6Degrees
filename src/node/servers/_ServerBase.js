var createServer = require("http").createServer, http = require("http"), readFile = require("fs").readFile, sys = require("sys"), url = require("url"), dojo = require("../utility/dojo.js");
DEBUG = false;
